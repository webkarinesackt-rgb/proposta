...
export const mockProposal: Proposal = {
  ...
  agency_settings: {
    ...
    experts: [
      { id: '1', name: 'Dra. Mariana Costa',   handle: '@dramarianacosta',   role: 'Dermatologista',           followers: '314K', photo_url: '/experts/imgi_44_Group-1707478395.png' },
      { id: '2', name: 'Lucas Mendonça',        handle: '@lucasmendonca',     role: 'CEO, Board Academy',       followers: '2.5M', photo_url: '/experts/imgi_45_Group-1707478394-1.png' },
      { id: '3', name: 'Dra. Camila Rocha',     handle: '@dracamilarocha',    role: 'Psicóloga Clínica',        followers: '25K',  photo_url: '/experts/imgi_46_Group-1707478397-2.png' },
      { id: '4', name: 'Rafael Augusto',        handle: '@rafaelaugustoadv',  role: 'Advogado Tributarista',    followers: '110K', photo_url: '/experts/imgi_47_Group-1707478398.png' },
      { id: '5', name: 'Beatriz Lopes',         handle: '@beatrizlopesnutri', role: 'Nutricionista',            followers: '768K', photo_url: '/experts/imgi_48_Group-1707478396-2.png' },
      { id: '6', name: 'Eduardo Pires',         handle: '@eduardopiresfisio', role: 'Fisioterapeuta',           followers: '372K', photo_url: '/experts/imgi_49_Group-1707478400-1.png' },
      { id: '7', name: 'Ana Flávia Moraes',     handle: '@anaflaviamoraes',   role: 'Coach de Carreira',        followers: '89K',  photo_url: '/experts/imgi_50_Group-1707478399.png' },
    ],
